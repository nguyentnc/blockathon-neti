...
export interface VRC25Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "allowance"
...
export interface VRC25 extends BaseContract {
  connect(runner?: ContractRunner | null): VRC25;
  waitForDeployment(): Promise<this>;

  interface: VRC25Interface;
