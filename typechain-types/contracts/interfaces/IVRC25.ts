...
export interface IVRC25Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
  ...
  getEvent(
    nameOrSignatureOrTopic: "Approval" | "Fee" | "Transfer"
  ): EventFragment;
...
export interface IVRC25 extends BaseContract {
  connect(runner?: ContractRunner | null): IVRC25;
  waitForDeployment(): Promise<this>;

  interface: IVRC25Interface;
  ...
  transfer: TypedContractMethod<
    [recipient: AddressLike, value: BigNumberish],
    [boolean],
    "nonpayable"
  >;
